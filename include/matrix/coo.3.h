...
struct Coo3
{
    ...
    // Getters
    IT get_row_index (IT i) const { return elements[i].row; }
    IT get_column_index (IT i) const { return elements[i].col; }
    T get_value (IT i) const { return elements[i].val; }
